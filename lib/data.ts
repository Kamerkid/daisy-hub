...
const products: IProductInput[] = [
    {
        name: 'Nike Mens Slim Fit  long-sleeveT-shirt',
  ...
  // Watches
  {
    ...
    numSales: 48,
    description:
      'Casing: Case made of stainless steel Case shape: round Case color: silver Glass: Hardlex Clasp type: Fold over clasp with safety',
    sizes: [],
    colors: [],
